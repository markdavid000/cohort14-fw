        ...
        <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl p-6">
          ...
          {step === "form" && (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-[#111] border border-gray-800 rounded-lg p-4 flex items-start gap-3">
                <svg
                  className="w-4 h-4 text-[#7FFFD4] mt-0.5 shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-gray-400 text-xs leading-relaxed">
                  ...
                  before other signers can confirm. The transaction
                  auto-executes once the threshold is reached.
                </p>
              </div>
          ...
          {step === "success" && (
            <div className="flex flex-col items-center py-8 gap-5 text-center">
              <div
                className="w-14 h-14 rounded-full bg-[#7FFFD4]/10 border border-[#7FFFD4]/30
                              flex items-center justify-center"
              >
                <svg
                  className="w-7 h-7 text-[#7FFFD4]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              {txHash && (
                <div className="w-full bg-[#111] rounded-lg p-3 border border-gray-800">
                  ...
                  <p className="text-[#7FFFD4] text-xs font-mono break-all">
                    {txHash}
                  </p>
                </div>
              )}
